...
function identify_modifier_kses () {
    ...
    'licence'         =>'GPL',
    'help'    	=> 'At the moment if you want to change the allowed html tags, you need to edit the file modifier.kses.php and edit the allowedtags array. Check the kses website for documentation.'
  );
}
