 ...
 *
 * @package bBlog
 * @author Elie `woe` BLETON - <lordwo@sourceforge.net> - last modified by $LastChangedBy: $
 * @version $Id: $
 ...
 *
 * Little TODO:
 * @todo Add addslashes()/stripslashes() everywhere it's required to support nifty setting name / setting values.
 */

/**
 * @todo add a docblock here
 */
class SettingsAPI 
{
